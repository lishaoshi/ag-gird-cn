export default function getDocDefinition(
  ...
  return (function() {
    ...
    const footer = PDF_FOOTER ? PDF_FOOTER : (PDF_WITH_FOOTER_PAGE_COUNT
      ? function(currentPage, pageCount) {
          return {
            text: '页码:' + currentPage.toString() + " / " + pageCount,
            margin: [20]
          }
        }
      : null)
    ...
    const hLineWidth = (i, node) => PDF_BORDER_H_WIDTH

    const vLineWidth = (i, node) => PDF_BORDER_V_WIDTH
